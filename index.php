		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				<li data-transition="parallaxvertical">
					<img src="img/slides/image3.jpg"  alt="" width="1920" height="705" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
					...
					<div class="tp-caption sfb tp-resizeme gardener-caption-p" 
				        ...
				        data-transform_out="o:0" 
				        data-start="1500">
						"We help enhance the beauty of your outdoor space with expert lawn and garden care. <br/>Trust us to bring out the best in your landscape, season after season."
				    </div>
				...
				<li data-transition="parallaxvertical">
					<img src="img/slides/image1.jpg"  alt=""  width="1920" height="705" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="2" >
					...
					<div class="tp-caption sfb tp-resizeme gardener-caption-p" 
				        ...
				        data-transform_out="o:0" 
				        data-start="1500">
						"Transform your yard with our expert lawn renovation and vibrant flowerscaping services.<br/> We revive tired lawns and craft colorful, eye-catching garden designs that thrive."
				    </div>
					<!-- <div class="tp-caption sfb tp-resizeme" 
				        data-x="left" data-hoffset="0" 
				        data-y="top" data-voffset="455" 
				...
				<li data-transition="parallaxvertical">
					<img src="img/slides/image2.jpg"  alt=""  width="1920" height="705" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" >
					<div class="tp-caption sfl tp-resizeme gardener-caption-h1" 
				        data-x="left" data-hoffset="0" 
				        data-y="top" data-voffset="190" 
				        data-whitespace="nowrap"
					...
					<div class="tp-caption sfb tp-resizeme gardener-caption-p" 
				        ...
				        data-transform_out="o:0" 
				        data-start="1500">
					"Enhance your outdoor spaces with Green Planet’s expert exterior design services.<br/> We create sustainable, beautiful environments that blend nature with style."
				    </div>
					<div class="tp-caption sfb tp-resizeme" 
				        data-x="left" data-hoffset="0" 
				        data-y="top" data-voffset="455" 
...
<!-- 
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                	<div class="single-service-item">
                        ...
                        <div class="service-text">
                        	<h4>Weed and Bed Maintenance</h4>
                            <p>Duis aute irure dolor in reprehend erit in voluptate velit esse.</p>
                        </div>
                    </div>
                </div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                	<div class="single-service-item">
                        ...
                        <div class="service-text">
                        	<h4>Tree and Bush Removal/Trimming</h4>
                            <p>Duis aute irure dolor in reprehend erit in voluptate velit esse.</p>
                        </div>
                    </div>
                </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-12">
					<h2>Welcome to  Horseshow Lawn Care </h2>
					<p>We're a family-run lawn care business proudly serving Central Texas with Christian values and small-town reliability. Rooted in honesty and hard work, we focus on providing dependable, high-quality service every time. As lifelong members of this community, we believe in doing right by our neighbors. Our commitment to quality over quantity ensures your lawn gets the attention it deserves. With us, you'll get trustworthy service backed by faith, family, and pride in every job. I.</p>
					<h3><i>We are available for 24/7 for Moving Services</i></h3>
	...
	<!-- <section id="video-section-gardener">
		<div class="container">
			<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 video-preview">
				<a href="http://www.youtube.com/watch?v=hMHAcYsvxHE" data-toggle="modal" data-target=".video-popup-modal">
	...
	<!-- <section class="video-popup">
			<div class="modal fade video-popup-modal" id="video-popup-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title text-center" id="myModalLabel">Our Video Gallery</h4>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
						<ul class="bxslider video-gallery" id="yt-player">
							...
							<li>
								<iframe width="600" height="400" src="https://www.youtube.com/embed/e2O4m1YDrWU" allowfullscreen></iframe>
							</li>
							<li>
								<iframe width="600" height="400" src="https://www.youtube.com/embed/LANFffK5g2s" allowfullscreen></iframe>
							</li>
						</ul>
					</div>
				</div>
            ...
            <!-- <div class="row">
            	<div class="dedicated-team-items owl-carousel owl-theme"> -->
                	...
                	<!-- <div class="item">
                    	<div class="dedicated-team-single-item">
                        	<div class="dedicated-team-img-holder">
                                <img src="img/dedicated-team/dedicated-team-1.jpg" alt="">
                                <div class="overlay">
                	...
                	<!-- <div class="item">
                    	<div class="dedicated-team-single-item">
                        	<div class="dedicated-team-img-holder">
                                <img src="img/dedicated-team/dedicated-team-2.jpg" alt="">
                                <div class="overlay">
	                                <div class="inner-holder">
	                                	<ul>
	                                		<li><a href="#"><i class="fa fa-facebook"></i></a></li>
                	...
                	<!-- <div class="item">
                    	<div class="dedicated-team-single-item">
                        	<div class="dedicated-team-img-holder">
                                <img src="img/dedicated-team/dedicated-team-3.jpg" alt="">
                                <div class="overlay">
	                                <div class="inner-holder">
	                                	<ul>
	                                		<li><a href="#"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 single-blog-post">
					...
					<a href="blog-details.html"><h2>Heading of Blog</h2></a>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 single-blog-post">
					<div class="img-holder">
						<img src="img/blog-gardener/2.jpg" alt="">
						<div class="overlay">
							<div class="inner-holder">
								<ul class="button">
									<li><a href="blog-details.html"><i class="fa fa-link"></i></a></li>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 single-blog-post">
					<div class="img-holder">
						<img src="img/blog-gardener/3.jpg" alt="">
						<div class="overlay">
							<div class="inner-holder">
								<ul class="button">
									<li><a href="blog-details.html"><i class="fa fa-link"></i></a></li>
